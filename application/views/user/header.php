...
<head>
  ...
  <title>TUGAS SISTEM PAKAR</title>
</head>
<body>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item <?php if( "/sp_tomato/user" == $_SERVER['REQUEST_URI'] ){ 
            ?> active <?php } ?>">
            <a class="nav-link" href="<?php echo base_url()?>index.php/user">Beranda</a>
          </li>
          <li class="nav-item <?php if( "/sp_tomato/user/data_penyakit" == $_SERVER['REQUEST_URI'] ){ 
            ?> active <?php } ?>">
            <a class="nav-link " href="<?php echo base_url()?>index.php/user/data_penyakit">Data Hama Dan Penyakit</a>
          </li>
        </ul>
      </div>
    </div>
